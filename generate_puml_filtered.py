...
ALLOWED_MODULES = {'cluster', 'gestion-de-conexiones', 'main', 'persistencia', 'protocolo', 'red', 'servicios'}
...
def main():
    base_dir = '/home/zebastor/Documents/mis/sw2/p2p/P2P_Server'
    classes = {}
    ...
    with open('diagrama_clases_filtrado.puml', 'w', encoding='utf-8') as f:
        f.write('\n'.join(puml))
    print("PlantUML generated at diagrama_clases_filtrado.puml")
