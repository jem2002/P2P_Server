 ...
 */
public interface PrivateMessageDeliveryStrategy {
     ...
     */
    boolean deliver(String jsonMessage, String targetUsername, String fromUser, String rawContent, String clientIp) throws Exception;
}
