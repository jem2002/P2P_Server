...
-- ------------------------------------------------------------
-- Tabla: comments
-- Descripción: Comentarios y análisis de sentimiento asociados
--              a los documentos e hilos de usuarios.
-- Dependencias: documents (document_id), users (user_id)
-- Política ON DELETE: CASCADE — si se elimina el documento o el
--   usuario, sus comentarios asociados se borran automáticamente.
-- ------------------------------------------------------------
CREATE TABLE comments (
    ...
    -- Restricción a nivel de tabla para asegurar el rango 0 a 100
                          CONSTRAINT chk_comments_confidence CHECK (confidence >= 0 AND confidence <= 100),
